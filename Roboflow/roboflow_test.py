...
image_name = "OpenCV/output/image13"

# visualize your prediction
print(mob_model.predict(image_name + ".jpg", confidence=40, overlap=20).json().get('predictions'))
print(tree_model.predict(image_name + ".jpg", confidence=40, overlap=20).json().get('predictions'))

# visualize your prediction
mob_model.predict(image_name + ".jpg", confidence=10, overlap=10).save(image_name + "_mob.jpg")
tree_model.predict(image_name + ".jpg", confidence=80, overlap=10).save(image_name + "_tree.jpg")